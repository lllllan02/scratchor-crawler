...
func TestGetQuestion(t *testing.T) {
	t.Run("单选题", func(t *testing.T) {
		view, err := client.GetQuestion("https://tiku.scratchor.com/question/view/abjyobpc2yhjb2ei")
	...
	t.Run("多选题", func(t *testing.T) {
		view, err := client.GetQuestion("https://tiku.scratchor.com/question/view/hrslpuuqoqvaytgk")
		assert.NoError(t, err)
		assert.Equal(t, &Question{
	...
	t.Run("判断题", func(t *testing.T) {
		view, err := client.GetQuestion("https://tiku.scratchor.com/question/view/n70nezbpz7jhjjrc")
		assert.NoError(t, err)
		assert.Equal(t, &Question{
			Tags: []string{"练习"},
			QuestionBody: &QuestionBody{
	...
	t.Run("填空题", func(t *testing.T) {
		view, err := client.GetQuestion("https://tiku.scratchor.com/question/view/ifufbngvurxwrtl3")
		assert.NoError(t, err)
		assert.Equal(t, &Question{
			Tags: []string{"练习"},
			QuestionBody: &QuestionBody{
	...
	t.Run("问答题", func(t *testing.T) {
		view, err := client.GetQuestion("https://tiku.scratchor.com/question/view/d9pvk7okovzdtu2d")
		assert.NoError(t, err)
		assert.Equal(t, &Question{
	...
	t.Run("组合题", func(t *testing.T) {
		view, err := client.GetQuestion("https://tiku.scratchor.com/question/view/syrdjesndgxqiobb")
		assert.NoError(t, err)
		assert.Equal(t, &Question{
